    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <input type="hidden" name="" id="title" value="Salesman Summary Report">
            
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Salesman Summary Report</h5>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <form action="" method="get" class="form-inline">
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-2">
                                        <button type="submit"class="btn btn-success mt-4" name="btn_salesman_summary" id="btn_salesman_summary">Find</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table id="tbl_inventory_summary">
                            ...
                            <tbody>
                                ...
                                {
                                    $row_count += 1;
                                    $salesman_id = $row['SLID'];
                                    $salesman_name = $row['SalesmansName'];
                                    $commision_rate = floatval($row['commision_rate']);
                                    ...
                                    AND invoiceheader.Salesmans_SLID = ".$salesman_id."
                                    ...
                                    if(!empty($invData))
                                    {
                                        ...
                                        if($sold_qty > 0)
                                        {
                                            ...
                                            $commision_earned = ($sold_amount * $commision_rate) / 100;
                                            $commision_earned = round($commision_earned, 2);
                                            ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format((float)$average_sale, 2, ".", "");?></td>
                                                 <td><?php echo $commision_rate;?>%</td>
                                                <td><?php echo number_format((float)$commision_earned, 2, ".", "");?></td>
                                            </tr>
                                            <?php
                                        }//has value
                                    }//not empty
