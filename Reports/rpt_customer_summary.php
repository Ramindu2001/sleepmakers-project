    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <input type="hidden" name="" id="title" value="Customer Summary Report">
            
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Customer Summary Report</h5>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <form action="" method="get" class="form-inline">
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-success mt-4" name="btn_customer_summary" id="btn_customer_summary">Find</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <table id="tbl_inventory_summary">
                            ...
                            <tbody>
                                ...
                                foreach($custData as $row)
                                {
                                    ...
                                    FROM invoiceheader
                                    WHERE 
                                    invoiceheader.EffectiveDate BETWEEN '".$start_date."' AND '".$end_date."' 
                                    AND invoiceheader.customers_CTID = ".$customer_id."
                                    ...
                                    //get credit customer
                                    $sql_2 = "SELECT sum(CreditAmount) as total_credit, sum(DebitAmount) as total_debit FROM `creditcustomer` WHERE Customers_CTID = ".$customer_id.";";

                                    $custData = $dbObj->getData($sql_2);
                                    $total_credit = floatval($custData[0]['total_credit']);
                                    $total_debit = floatval($custData[0]['total_debit']);
                                    ...
                                    if(!empty($invData))
                                    {
                                        ...
                                        if($sold_qty > 0)
                                        {
                                            $average_sale = round($sold_amount / $bill_count, 2);
                                            ?>
                                            <tr>
                                                <td><?php echo $row_count;?></td>
                                                <td><?php echo $customer_name ."<br>". $customer_contact;?></td>
                                                <td><?php echo $bill_count;?></td>
                                                <td><b><?php echo number_format((float)$sold_amount, 2, ".", "");?></b></td>
                                                <td><?php echo $sold_qty;?></td>
                                                <td><?php echo number_format((float)$average_sale, 2, ".", "");?></td>
                                                <td><?php echo number_format((float)$total_credit, 2, ".", "");?></td>
                                                <td><?php echo number_format((float)$total_debit, 2, ".", "");?></td>
                                                <td><?php echo number_format((float)$credit_balance, 2, ".", "");?></td>
                                            </tr>
                                            <?php
                                        }//has value
                                    }//not empty
