    ...
    <div class="body-wrapper">
        ...
        ?>
         ...
         <input type="hidden" name="" id="shop_name" value="<?=$shop[0]['ShopName']?>">
            ...
            <input type="hidden" name="" id="title" value="Unit Name List">
         <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Unit Name List</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    ...
                    <tbody>
                        <?php 
                        $unitObj = new Report();
                        $unitData = $unitObj->unitlist($shop_id);
                        $i=1;
