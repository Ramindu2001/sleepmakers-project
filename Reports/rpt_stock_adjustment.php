    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <input type="hidden" name="" id="title" value="Stock Adjustment Report">
            
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Stock Adjustment Report</h5>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <form action="../Controller/ReportController.php" method="POST" class="form-inline">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button class="btn btn-success mt-4" name="btn_stock_adjustment" id="btn_stock_adjustment">Find</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table id="tbl_inventory_summary">
                            ...
                            <tbody>
                                ...
                                WHERE adjustheader.shop_SHID = ".$shop_id." AND adjustheader.EffectiveDate BETWEEN '".$start_date."' AND '".$end_date."';";
                                ...
                                foreach($invData as $row)
                                {
                                    ...
                                    $adjust_type = $row['AdjustmentTypeName'];
                                    $adjust_qty = floatval($row['AdjustProdQty']);
                                    $adjust_date = $row['EffectiveDate'];
                                    $user_name = $row['UserName'];
                                    ?>
                                    <tr>
                                        <td><?php echo $row_count;?></td>
                                        <td><?php echo $adjust_date;?></td>
                                        <td><?php echo $barcode;?></td>
                                        <td><?php echo $item_name;?></td>
                                        <td><?php echo $adjust_type;?></td>
                                        <td><?php echo $adjust_qty;?></td>
