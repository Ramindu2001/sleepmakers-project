    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Header Information -->
                <div class="mb-3">
                    <h5><strong>Trial Balance</strong></h5>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="../Controller/ReportController.php" method="POST" class="form-inline">
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-4">
                                    <button type="submit" name="btn_trialbalance_date" id="btn-filter"
                        ...
                        <table class="table table-bordered table-hover" id="tbl_trial_balance">
                            <thead>
                            <tr>
                                <th>Account</th>
