    ...
    <div class="body-wrapper">
        ...
        ?>
         <div class="container-fluid">
            ...
            <input type="hidden" name="" id="title" value="Supplier Return">
            <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Supplier Return</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    <form action="./supplier_return" class="form-inline" method="get" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-md-5">
                    ...
                    <tbody>
                        <?php 
                        $supplier = new Report();
                        $supplierdata = $supplier->supplierreturn($shop_id);
                        $i = 1;
                        $return_amount =0;
                    ...
                    <tfoot>
                    <td colspan="4"></td> 
                    <td class="text-end"><strong>Total Return Amount: <?php echo number_format($return_amount, 2); ?></strong><input type="hidden" name="return_amount" id="return_amount" value="<?=$return_amount?>"></td>
                    </tfoot>
                </table>
                </div>
                </div>
...
<?php require_once '../View/footer.php';?> 
    ...
    <script src="../Assets/jquery/supplier_return.js"></script>
