    ...
    <div class="body-wrapper">
        ...
        ?>
         <div class="container-fluid">
            ...
            <input type="hidden" name="" id="title" value="Category Selling Report">
            <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Category Report</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        $topproductdata = $topproduct->category($shop_id);
                        $i = 1;
...
<?php require_once '../View/footer.php';?> 
    ...
    <script src="../Assets/jquery/category_report.js"></script>
