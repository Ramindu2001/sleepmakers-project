    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Invoice Return Report</h5>
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table table-hover" id="tbl_category">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET["from_date"]) && $_GET["to_date"])
                                        {
                                            ...
                                            $saleData = $saleObj->returninvoicereport($shop_id,$type=0,$from_date,$to_date);
                                        }
                                        else
                                        {
                                            $saleData = $saleObj->returninvoicereport($shop_id,$type=0);
                                        }
                                        $i=1;
                                        $total_discount =0;
                                        $total_amount =0;
                                        ...
                                        if($count>0)
                                        {
                                            foreach ($saleData as $row) 
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="../Public/return_view_details.php?id=<?=$row["RIHID"]?>" class="">View Info</a></td> 
                                                </tr>
                                                <?php 
                                                $i++;
                                            }
