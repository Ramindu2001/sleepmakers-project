    ...
    <div class="body-wrapper">
        ...
        ?>
         <div class="container-fluid">
            ...
            <input type="hidden" name="" id="title" value="Customer Credit">
            <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Customer Credit</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    <form action="./customer-credit" class="form-inline" method="get" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="" for="from_date">Start Date</label>
                                    <input type="date" name="from_date" class="form-control datepicker hasDatepicker" id="from_date" placeholder="Start Date" value="<?php echo $effective_date;?>">
                                </div> 
                            </div>
                            <div class="col-md-5">
                                  <div class="form-group">
                                    <label class="" for="to_date">End Date</label>
                                    <input type="date" name="to_date" class="form-control datepicker hasDatepicker" id="to_date" placeholder="End Date" value="<?php echo $effective_date;?>">
                                </div>
                            </div>
                    ...
                    <tbody>
                        ...
                        $customerData = $customerObj->credit($shop_id);
                        $i = 1;
                        $total=0;
                    ...
                    <tr>
                        <td colspan="5"></td>
                        <td><strong>Total  Credit Balance</strong></td>
                        <td><strong><?php echo $total; ?></strong> <input type="hidden" name="total" id="total" value="<?=$total?>"></td>
                    </tr>
                </table>
                </div>
                </div>
