...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    ?>
         <div class="container-fluid">
            ...
            <input type="hidden" name="" id="title" value="Product Variations">
         <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Product Variations Report</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    ...
                    <tbody>
                        <?php 
                        $variationObj = new Report();
                        $variationData = $variationObj->variations();
                        $i=1;
                        foreach ($variationData as $row) 
                        {
                            ?>
                            <tr>
                                <td> <?php echo $i;?> </td>
                                <td> <?php echo $row['ItemName'] ?></td>   
                                <td> <?php echo $row['VariationName']?></td>
                            </tr>
                            <?php 
                            $i++;
                        }
