...
<body onload="window.print()">
        ...
        <table id="tbl_cart">
            ...
            foreach($transferData as $row)
            {
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo $row['UnitPurchasePrice'];?></td>
                    <td style="text-align: right;"><?php echo $row['UnitSellingPrice'];?></td>
                    <?php 
                        if($shopObj->hasExpiry($shop_id))
                        {
                            ?>
                    ...
                    ?>
                    <td style="text-align: right;"><?php echo $row['TransferTotalAmount'];?></td>
                </tr>
                <?php 
            }//foreach
    ...
    <div id="div_summary">
        ...
        $sql = "SELECT * FROM `transfertransactions` 
        INNER JOIN paymethod ON paymethod.PMID = transfertransactions.paymethod_id
        ...
        <table id="tbl_summary">
            ...
            foreach($payData as $row)
            {
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo $row['TrnTransactionAmount'];?></td>
                </tr>
                <?php 
            }//foreach
            ?>
            ...
            <tr>
                ...
                <td style="text-align: right;"><?php echo $total_transfer;?></td>
            </tr>
            <tr>
                <td>Total Receive</td>
                <td style="text-align: right;"><?php echo $total_receive;?></td>
            </tr>
            <tr>
