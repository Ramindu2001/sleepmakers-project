    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <input type="hidden" name="" id="title" value="Salesman Detail Report">
            
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Salesman Detail Report</h5>
                    </div>
                    <div class="card-body">
                        <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select name="cmb_salesman" id="cmb_salesman" class="form-select">
                                            ...
                                            {
                                                $is_select = "";
                                                if($salesman_id == $row['SLID'])
                                                {
                                                    $is_select = "selected";
                                                }//has salesman
                                                ?>
                                                <option value="<?php echo $row['SLID'];?>" <?php echo $is_select;?>><?php echo $row['SalesmansName'];?></option>
                                                <?php 
                                            }//foreach      
                                            ?>
                                        </select>
                                    ...
                                    ?>
                                    <div class="col-md-2">
                                        <button class="btn btn-success mt-4" name="btn_salesman_detail" id="btn_salesman_detail">Find</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table id="tbl_inventory_summary">
                            ...
                            <tbody>
                                ...
                                if($salesman_id > 0)
                                {
                                    ...
                                    WHERE Salesmans_SLID = ".$salesman_id." AND EffectiveDate BETWEEN '".$start_date."' AND '".$end_date."' AND invoiceheader.InvStat=1 $add";
                                }//has salesman
                                else
                                {
                                    $sql = "SELECT * FROM `invoiceheader` 
