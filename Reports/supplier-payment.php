    ...
    <div class="body-wrapper">
        ...
        ?>
         <div class="container-fluid">
            ...
            <input type="hidden" name="" id="title" value="Supplier Payment">
            <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Supplier Payment</h5>
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                    ...
                    <tbody>
                        <?php 
                        $supplierpayment= new Report();
                        if(isset($_GET["from_date"]) && isset($_GET["to_date"]))
                        {
                            $start=$_GET["from_date"];
                            $end=$_GET["to_date"];
                            $supplierpaymentdata = $supplierpayment->supplierpayment($shop_id,$start,$end);
                        }
                        else
                        {
