$(document).ready(function() {
    ...
    var product_selling =$('#product_selling').val();
        ...
        buttons: [
            ...
            $(win.document.body).css('font-size', '10pt').append(
                '<div style="display:flex; justify-content:end;">'+
                    ...
                    '<td>'+
                    '<p style="margin-bottom: 5px;"> ' + product_purchase + '</p>' +
                    '</td>'+
                    '<tr>' +
                    '</div>'+
                    '<div style="width:100%;">' +
                    '<tr>' +
                    '<td colspan="5"></td>' +
                    '<td><strong>Total Product Selling:</strong></td>' +
                    '<td>'+
                    '<p style="margin-bottom: 5px;"> ' + product_selling + '</p>' +
                    '</td>'+
                    '<tr>' +
                    '</div>'+
                    '</div>'
