        ...
        setTimeout(function(){
            ...
            if(isset($_SESSION["deliveryNote"]))    
            {
                if($_SESSION["deliveryNote"]==1)
                {
                    ...
                    ?>
                    window.location="./WholesaleInvoice-nsc.php?invoice_id=<?=$invoice?>";
                    <?php
                }
                else
                {
...
<div id="invoice_detail">
    ...
    <div class="header-flex ">
        <div class="header-main d-flex">
            <div class="d-flex" style="display:flex; justify-content:start;">
                <div class="w-80" style="background:#262932;width:56%;height: 110px;border-radius: 0 0 132px 0; padding:10px;">
                    <img src="../Assets/Images/shop_images/ncs.jpg" alt="" style="width:100px;">
                    <h2 style="padding-top:0; font-size:18px; color:White; font-weight:300; font-family: 'Quicksand', serif; text-transform:uppercase;">New Season Center | Luta Bicycle Co.</h2>
                </div>
            </div>
            <div class="d-flex" style="display:flex; justify-content:end;">
                <div class="w-80" style="position:absolute;top: 0px;background:#e11b34;width:75%;height:65px;border-radius: 0 0 0 132px; display:flex; justify-content:center; padding:10px 0 0 0;">
            ...
            <div class="summary-section details-section">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="background:#e11b34;color:white;"><?=number_format((float)$NetAmount, 2, '.', ',');?></td>
                    </tr>
                    <tr>
                        <td>Received:</th>
                        <td>0.00</td>
                    ...
                    <tr>
                        <td>Balance:</td>
                        <td><?=number_format((float)$cust_balance, 2, '.', ',');?></td>
                    </tr>
                    <tr>
    ...
    <div style="display:flex; justify-content:center;">
        <div class="w-50">
            ...
            <p style="font-size:12px;">Four Hundred Thirty Two Thousand Nine Five Only</p>
        </div>
        <div class="w-50"></div>
    </div>
    <div style="display:flex; justify-content:center;">
