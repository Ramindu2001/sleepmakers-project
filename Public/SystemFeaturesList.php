        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper">
                ...
                <div class="container-fluid">
                    <h5 class="card-title fw-semibold mb-4">System Features List</h5>
                                      ...
                                      <table class="table search-table align-middle text-nowrap" id="tbl_active_store">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $ModuleName = $ModuleObj->getFeatures(); 
                                                $i=1;
                                                foreach ($ModuleName as $Module): ?>   
                                                    <tr>
                                                    <td><?php echo $i;?></td>
                                                    <td><?php echo $Module['SFID'];?></td>
                                                    <td><?php echo $Module['ModuleName'];?></td>
                                                    <td><?php echo $Module['FeatureName'];?></td>
                                                    <td>
                                                        <a href="SystemFeaturesList.php?Fe_Id=<?php echo $Module['SFID'];?>">Edit</a>
                                                    </td>    
                                                    </tr>                                         
                                            <?php 
                                        $i++;
