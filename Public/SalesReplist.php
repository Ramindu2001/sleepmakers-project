...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
        ...
        include "../View/modals/SalesRepmodel.php";
        ?>
        <!--  Header End -->
        ...
        <?php 
            ...
            <h5 class="card-title fw-semibold mb-2" style="margin-top: 0px;">Sales Rep list </h5>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {
                        ?>
                        <button class="btn btn-primary border border-primary rounded-pill ml-1" id="btn_open_SalesRep">Add Sales Rep</button>
                        <?php
                    }
                    ?>
