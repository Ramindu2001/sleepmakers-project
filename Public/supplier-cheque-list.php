            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h5>Supplier Cheque List</h5>
                    </div>
                    <div class="card-body">
                        <label for="search_invoice" class="form-label">Search </label>
                        <input type="text" id="search_invoice" class="form-control" placeholder="GRN No / Cheque No / Supplier Name / Bank / .....">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM supcheq sc
                                                ...
                                                WHERE sc.shop_SHID='$shop_id' ORDER BY sc.chq_no DESC;";
                                        ...
                                        foreach($invData as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($row["type"]==1){?> <span class="text-danger" style="font-weight:700;"><i class="ti ti-outbound" style=" display:inline-block; transform:rotate(311deg);"></i> Issued Cheque</span><?php } else{ ?><span style="font-weight:700; color:green;"> <i class="ti ti-outbound" style=" display: inline-block; transform: rotate(133deg); "></i> Received Cheque </span>  <?php }?>
                                                </td>
                                                <td><?php 
                                                if($row["chq_stat"]==0)
                                                {
                                                ...
                                                <td>
                                                    ...
                                                    if($row["transferedFrom"]!=0)
                                                    {
                                                        ...
                                                        $sql = "SELECT * FROM `custcheq` cc
                                                                ...
                                                                WHERE cc.CCQID='$transferedFrom';";
                                                        $dbObj = new DBTransactions();
                                                        $invData = $dbObj->getData($sql);
                                                        if(isset($invData[0]["chq_no"]))
                                                        {
                                                            echo $invData[0]["chq_no"]." <br> ".$invData[0]["CustName"]." <br> ".$invData[0]["chqNo"];
                                                        }
                                                    }
                                                    ?>
                                                </td>
                                                <td><?=$row["SupplierName"]." - ".$row["Distributer"]?></td>
                                                <td><?=$row["bank"]?></td>
