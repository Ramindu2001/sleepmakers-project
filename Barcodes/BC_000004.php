...
<head>
    ...
    for($j=0; $j<$num_row; $j++)
    {
        ...
        for ($i=0; $i < $num_col; $i++)
        { 
            $html .= "<div class='div_cell' style='border:1px solid black;'>";

            $html .= "<p style='margin: 15px; text-align:center; font-size: 80px;'>".$shop_name."</p>"; 

            // $html .= "<p style='margin: 2px; text-align:center; font-size: 15px;'>Rs: ".$product_price."</p>"; 
            $html .= "<img src='".$code_name."' style='width:80%; height:100px; margin-left:10%;'>";

            $html .= "<p style='margin: 5px; text-align:center; font-size: 40px;'>".$barcode."</p>"; 

            $html .= "<p style='margin: 5px; text-align:center; font-size: 60px;'>".$item_name."</p>"; 
