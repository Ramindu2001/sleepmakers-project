...
$purchase_price = $prodData[0]['PurchasePrice'];
...
<head>
    ...
    { 
        ...
        $html .= "<p style='margin: 5px; text-align:center; font-size: 18px;'>Fancy Mahal</p>"; 
        ...
        $html .= "<p style='margin: 5px; text-align:center; font-size: 20px;'>Rs: ".$product_price."</p>"; 
